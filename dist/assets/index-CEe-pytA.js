...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(e,t,n){let r=new Float32Array(Ea),i=new G(0,1,0);return new yi({name:`SphericalGaussianBlur`,defines:{n:Ea,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ua(),fragmentShader:`
	...
	`}var Wa=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,rl=`यत्र योगेश्वरः कृष्णो यत्र पार्थो धनुर्धरः ।`,il=`तत्र श्रीर्विजयो भूतिर्ध्रुवा नीतिर्मतिर्मम ॥`,$=1024,al=1536;function ol(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}async function sl(e){if(document.fonts&&document.fonts.ready)try{await document.fonts.ready}catch{}let t=document.createElement(`canvas`);t.width=$,t.height=al;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,al);r.addColorStop(0,`#0a0218`),r.addColorStop(.5,`#1a0432`),r.addColorStop(1,`#0a0218`),n.fillStyle=r,n.fillRect(0,0,$,al),n.strokeStyle=`rgba(255,43,214,0.08)`,n.lineWidth=1;for(let e=0;e<=$;e+=32)n.beginPath(),n.moveTo(e,0),n.lineTo(e,al),n.stroke();for(let e=0;e<=al;e+=32)n.beginPath(),n.moveTo(0,e),n.lineTo($,e),n.stroke();n.strokeStyle=`#00f0ff`,n.lineWidth=6,n.shadowColor=`#00f0ff`,n.shadowBlur=20,n.strokeRect(12,12,$-24,al-24),n.shadowBlur=0,n.strokeStyle=`#ff2bd6`,n.lineWidth=4,n.shadowColor=`#ff2bd6`,n.shadowBlur=12,n.beginPath(),n.moveTo(30,110),n.lineTo(30,30),n.lineTo(110,30),n.stroke(),n.beginPath(),n.moveTo($-30-80,30),n.lineTo($-30,30),n.lineTo($-30,110),n.stroke(),n.beginPath(),n.moveTo(30,al-30-80),n.lineTo(30,al-30),n.lineTo(110,al-30),n.stroke(),n.beginPath(),n.moveTo($-30-80,al-30),n.lineTo($-30,al-30),n.lineTo($-30,al-30-80),n.stroke(),n.shadowBlur=0;let i=new Image;i.crossOrigin=`anonymous`,i.src=`/pfp.webp`,await new Promise(e=>{i.onload=()=>e(),i.onerror=()=>e()});let a=($-620)/2,s=n.createRadialGradient($/2,390,620*.3,$/2,390,620*.75);s.addColorStop(0,`rgba(255,43,214,0.35)`),s.addColorStop(1,`rgba(255,43,214,0)`),n.fillStyle=s,n.fillRect(a-80,0,780,780),n.save(),ol(n,a-8,72,636,636,16),n.fillStyle=`#000`,n.fill(),n.clip(),i.complete&&i.naturalWidth>0?n.drawImage(i,a,80,620,620):(n.fillStyle=`#1a0432`,n.fillRect(a,80,620,620),n.fillStyle=`#ff2bd6`,n.font=`bold 48px Orbitron, sans-serif`,n.textAlign=`center`,n.fillText(`NO SIGNAL`,$/2,390)),n.restore(),n.strokeStyle=`#ff2bd6`,n.lineWidth=4,n.shadowColor=`#ff2bd6`,n.shadowBlur=18,ol(n,a-8,72,636,636,16),n.stroke(),n.shadowBlur=0;let c=760;n.textAlign=`center`,n.fillStyle=`#fff4d0`,n.shadowColor=`#ffb84d`,n.shadowBlur=8,n.font=`700 42px "Noto Sans Devanagari", serif`,n.fillText(rl,$/2,c),c+=56,n.fillText(il,$/2,c),n.shadowBlur=0,c+=70,n.strokeStyle=`rgba(0,240,255,0.5)`,n.lineWidth=2,n.beginPath(),n.moveTo($*.2,c),n.lineTo($*.8,c),n.stroke(),c+=60,n.fillStyle=`#00f0ff`,n.shadowColor=`#00f0ff`,n.shadowBlur=25,n.font=`900 110px Orbitron, sans-serif`,n.fillText(e.name,$/2,c+30),n.shadowBlur=0,n.fillStyle=`rgba(255,43,214,0.6)`,n.fillText(e.name,515,c+30),n.fillStyle=`#00f0ff`,n.fillText(e.name,$/2,c+30),c+=160;let l=[[`AGE`,String(e.age)],[`COLLEGE`,e.college],[`ROLE`,e.role.toUpperCase()],[`GITHUB`,e.github]];n.font=`34px "Share Tech Mono", monospace`;let u=$*.18,d=$*.4;for(let[e,t]of l){n.textAlign=`left`,n.fillStyle=`#ff2bd6`,n.fillText(e,u,c),n.fillStyle=`#9ad7ff`;let r=$*.42,i=t;for(;n.measureText(i).width>r&&i.length>1;)i=i.slice(0,-1);i!==t&&(i=i.slice(0,-1)+`…`),n.fillText(i,d,c),c+=56}n.fillStyle=`#00f0ff`,n.shadowColor=`#00f0ff`,n.shadowBlur=12,n.font=`28px "Share Tech Mono", monospace`,n.textAlign=`center`,n.fillText(`// END OF TRANSMISSION //`,$/2,al-50),n.shadowBlur=0,n.fillStyle=`rgba(255,43,214,0.9)`,n.fillRect(40,40,200,4),n.fillRect($-240,40,200,4),n.fillStyle=`#ff2bd6`,n.font=`24px "Share Tech Mono", monospace`,n.textAlign=`center`,n.fillText(`PROFILE.dat`,$/2,50);let f=new ti(t);f.colorSpace=Fe,f.minFilter=o,f.magFilter=o,f.generateMipmaps=!1,f.needsUpdate=!0;let p=new yi({vertexShader:tl,fragmentShader:nl,transparent:!0,uniforms:{uTexture:{value:f},uTime:{value:0},uResolution:{value:new W($,al)},uGlitchStrength:{value:.55}}}),m=$/al*12,h=new an,g=new X(new ci(m,12),p);g.position.set(0,6.05,0),h.add(g);let _=new X(new ai(8.4,12.4,.2),new Y({color:524559}));_.position.set(0,6.05,-.15),h.add(_);let v=new Y({color:2756672}),y=new ai(.15,12.1,.15),b=new X(y,v);b.position.set(-3.7,12.1/2,-.2),h.add(b);let x=new X(y,v);return x.position.set(m/2-.3,12.1/2,-.2),h.add(x),{group:h,material:p,texture:f,collider:{min:new W(-8/2-.2,-.3),max:new W(4.2,.3)}}}var cl=1.7,ll=3,ul=6.5,dl=.3,fl=Math.PI/2-.05,pl=.0022,ml=class{dom;camera;colliders;chunkHalf;floorY;onBoundaryHit;yaw=0;pitch=0;keys=Object.create(null);locked=!1;boundaryTriggered=!1;_forward=new G;_right=new G;_move=new G;_testPos=new G;_onKeyDown=e=>{this.keys[e.code]=!0};_onKeyUp=e=>{this.keys[e.code]=!1};_onMouseMove=e=>{this.locked&&(this.yaw-=e.movementX*pl,this.pitch-=e.movementY*pl,this.pitch=Math.max(-fl,Math.min(fl,this.pitch)))};_onPointerLockChange=()=>{this.locked=document.pointerLockElement===this.dom};_onDomClick=()=>{this.locked||this.dom.requestPointerLock()};constructor(e){this.dom=e.domElement,this.camera=e.camera,this.colliders=e.colliders,this.chunkHalf=e.chunkHalf,this.floorY=e.floorY,this.onBoundaryHit=e.onBoundaryHit,this.camera.position.set(0,this.floorY+cl,10),this.yaw=0,window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp),document.addEventListener(`mousemove`,this._onMouseMove),document.addEventListener(`pointerlockchange`,this._onPointerLockChange),this.dom.addEventListener(`click`,this._onDomClick)}isLocked(){return this.locked}addCollider(e){this.colliders.push(e)}resetBoundary(){this.boundaryTriggered=!1}update(e){if(!this.locked)return this._applyLook(),{speed:`WALK`,pos:this.camera.position};this._forward.set(-Math.sin(this.yaw),0,-Math.cos(this.yaw)),this._right.set(Math.cos(this.yaw),0,-Math.sin(this.yaw)),this._move.set(0,0,0),this.keys.KeyW&&this._move.add(this._forward),this.keys.KeyS&&this._move.sub(this._forward),this.keys.KeyD&&this._move.add(this._right),this.keys.KeyA&&this._move.sub(this._right);let t=!!this.keys.ShiftLeft||!!this.keys.ShiftRight,n=t?ul:ll;return this._move.lengthSq()>0&&(this._move.normalize().multiplyScalar(n*e),this._tryMove(this._move)),this._applyLook(),{speed:t?`SPRINT`:`WALK`,pos:this.camera.position}}_applyLook(){let e=new Bt(this.pitch,this.yaw,0,`YXZ`);this.camera.quaternion.setFromEuler(e)}_tryMove(e){let t=this.camera.position,n=t.x+e.x;this._testPos.set(n,t.y,t.z),this._collidesAt(this._testPos)&&(e.x=0);let r=this.chunkHalf-dl;n>r&&(e.x=Math.min(e.x,r-t.x),this._signalBoundary()),n<-r&&(e.x=Math.max(e.x,-r-t.x),this._signalBoundary());let i=t.z+e.z;this._testPos.set(t.x+e.x,t.y,i),this._collidesAt(this._testPos)&&(e.z=0);let a=this.chunkHalf-dl;i>a&&(e.z=Math.min(e.z,a-t.z),this._signalBoundary()),i<-a&&(e.z=Math.max(e.z,-a-t.z),this._signalBoundary()),t.x+=e.x,t.z+=e.z,t.y=this.floorY+cl}_collidesAt(e){let t=dl;for(let n=0;n<this.colliders.length;n++){let r=this.colliders[n];if(e.x+t>r.min.x&&e.x-t<r.max.x&&e.z+t>r.min.y&&e.z-t<r.max.y)return!0}return!1}_signalBoundary(){this.boundaryTriggered||(this.boundaryTriggered=!0,this.onBoundaryHit())}dispose(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp),document.removeEventListener(`mousemove`,this._onMouseMove),document.removeEventListener(`pointerlockchange`,this._onPointerLockChange),this.dom.removeEventListener(`click`,this._onDomClick)}};function hl(e){let t=e.map((e,t)=>({mesh:e,baseColor:e.material.color.clone(),seed:t*7.31+1,flickerChance:.015+t%3*.008}));return{update(e){for(let n of t){let t=n.mesh.material,r=Math.sin(e*19+n.seed)*43758.5453;if(r-Math.floor(r)<n.flickerChance)t.color.copy(n.baseColor).multiplyScalar(.25);else{let r=.88+.12*Math.sin(e*33+n.seed*3);t.color.copy(n.baseColor).multiplyScalar(r)}}}}}function gl(){let e=new cr,t=new Float32Array(300*6),n=new Float32Array(300);for(let e=0;e<300;e++){let r=(Math.random()-.5)*40,i=Math.random()*22,a=(Math.random()-.5)*40;t[e*6]=r,t[e*6+1]=i+.5,t[e*6+2]=a,t[e*6+3]=r,t[e*6+4]=i,t[e*6+5]=a,n[e]=18+Math.random()*8}e.setAttribute(`position`,new qn(t,3));let r=new $r(e,new Vr({color:10147839,transparent:!0,opacity:.32,blending:2,depthWrite:!1}));return r.frustumCulled=!1,{mesh:r,update(t){let r=e.attributes.position.array;for(let e=0;e<300;e++){let i=n[e];if(r[e*6+1]-=i*t,r[e*6+4]-=i*t,r[e*6+4]<0){r[e*6+1]=22.5,r[e*6+4]=22;let t=(Math.random()-.5)*40,n=(Math.random()-.5)*40;r[e*6]=t,r[e*6+2]=n,r[e*6+3]=t,r[e*6+5]=n}}e.attributes.position.needsUpdate=!0}}}function _l(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=128;let r=n.getContext(`2d`);r.clearRect(0,0,256,128),r.strokeStyle=t,r.lineWidth=3,r.shadowColor=t,r.shadowBlur=10,r.strokeRect(8,8,240,112),r.shadowBlur=0,r.fillStyle=t,r.shadowColor=t,r.shadowBlur=8,r.font=`bold 38px "Orbitron", sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(e,256/2,128/2),r.shadowBlur=0;let i=new ti(n);return i.colorSpace=Fe,i.minFilter=o,i.magFilter=o,i.generateMipmaps=!1,i}function vl(){let e=new an,t=[{text:`NIGHT CITY`,color:`#ff2bd6`,pos:[-7,5.5,4]},{text:`CYBER 2077`,color:`#00f0ff`,pos:[6,6.5,-3]},{text:`NOMAD`,color:`#ffe600`,pos:[-5,4.8,-6]},{text:`NETRUN`,color:`#39ff14`,pos:[7,5.8,5]}],n=[];for(let r of t){let t=new Y({map:_l(r.text,r.color),transparent:!0,side:2,blending:2,depthWrite:!1,opacity:.85}),i=new X(new ci(2.2,1.1),t);i.position.set(r.pos[0],r.pos[1],r.pos[2]),e.add(i),n.push({mesh:i,bobSeed:Math.random()*10,baseY:r.pos[1]})}return{group:e,update(e){for(let t of n)t.mesh.rotation.y=e*.5,t.mesh.position.y=t.baseY+Math.sin(e*1.2+t.bobSeed)*.3}}}var yl=[{title:`CODE`,color:`#00f0ff`,skills:[`C++`,`JavaScript`,`TypeScript`,`Python`,`Java`]},{title:`GAME`,color:`#ff2bd6`,skills:[`Minecraft`,`Free Fire`,`Chess`,`Taekwondo`,`exploration`]},{title:`TECH`,color:`#ffe600`,skills:[`Git`,`Linux`,`Docker`,`Next.Js`,`Postgres`]},{title:`BUILD`,color:`#39ff14`,skills:[`Vibe Code`,`Software`,`Tools`,`Demos`,`Portfolios`]}],bl={name:`ARJUN!K`,age:19,college:`COEP Technological University`,role:`Gamer`,github:`https://github.com/arjun1k-dev`,email:`arjun1k.dev@gmail.com`,linkedin:`https://www.linkedin.com/in/arjun142235351`};function xl(e,t,n=56){let r=document.createElement(`canvas`);r.width=256,r.height=128;let i=r.getContext(`2d`);i.clearRect(0,0,256,128),i.fillStyle=t,i.shadowColor=t,i.shadowBlur=12,i.font=`bold ${n}px "Orbitron", sans-serif`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e,256/2,128/2);let a=new ti(r);return a.colorSpace=Fe,a.minFilter=o,a.magFilter=o,a.generateMipmaps=!1,a}function Sl(e,t,n){let r=new an,i=parseInt(e.color.slice(1),16),a=new X(new ai(.6,4,.6),new Y({color:1049634}));a.position.y=2,r.add(a);for(let e=0;e<4;e++){let t=new X(new ai(.64,.1,.64),new Y({color:i}));t.position.y=.5+e*1,r.add(t)}let o=new X(new ai(.7,.2,.7),new Y({color:i}));o.position.y=4.1,r.add(o);let s=xl(e.title,e.color,56),c=[{pos:[0,3,.32],rot:0},{pos:[0,3,-.32],rot:Math.PI},{pos:[.32,3,0],rot:Math.PI/2},{pos:[-.32,3,0],rot:-Math.PI/2}];for(let e of c){let t=new X(new ci(.8,.4),new Y({map:s,transparent:!0,side:2}));t.position.set(e.pos[0],e.pos[1],e.pos[2]),t.rotation.y=e.rot,r.add(t)}let l=document.createElement(`canvas`);l.width=l.height=128;let u=l.getContext(`2d`),d=parseInt(e.color.slice(1,3),16),f=parseInt(e.color.slice(3,5),16),p=parseInt(e.color.slice(5,7),16),m=u.createRadialGradient(64,64,0,64,64,64);m.addColorStop(0,`rgba(${d},${f},${p},0.6)`),m.addColorStop(.5,`rgba(${d},${f},${p},0.2)`),m.addColorStop(1,`rgba(${d},${f},${p},0)`),u.fillStyle=m,u.fillRect(0,0,128,128);let h=new ti(l);h.colorSpace=Fe;let g=new X(new ci(2.2,2.2),new Y({map:h,transparent:!0,depthWrite:!1,blending:2}));return g.rotation.x=-Math.PI/2,g.position.y=.04,r.add(g),r.position.set(t,0,n),{mesh:r,point:{position:new G(t,0,n),triggerRadius:2.5,id:`skill_${e.title}`,onEnter:()=>{let t=document.getElementById(`skill-overlay`);if(!t)return;let n=t.querySelector(`.skill-title`),r=t.querySelector(`.skill-list`);n.textContent=e.title,n.style.color=e.color,n.style.textShadow=`0 0 14px ${e.color}`,r.innerHTML=e.skills.map(e=>`<li>${e}</li>`).join(``),t.classList.add(`visible`)},onExit:()=>{let e=document.getElementById(`skill-overlay`);e&&e.classList.remove(`visible`)}}}}function Cl(e,t){let n=new an,r=new X(new ai(1.2,.2,1.2),new Y({color:1049634}));r.position.y=.1,n.add(r);let i=new X(new ai(1,2,.6),new Y({color:655896}));i.position.y=1.2,n.add(i);let a=new X(new ci(.8,1.4),new Y({color:61695}));a.position.set(0,1.3,.31),n.add(a);let o=xl(`CONTACT`,`#00f0ff`,48),s=new X(new ci(.7,.35),new Y({map:o,transparent:!0,side:2}));s.position.set(0,2,.32),n.add(s);let c=new X(new ai(1.1,.1,.7),new Y({color:16722902}));c.position.y=2.25,n.add(c);let l=document.createElement(`canvas`);l.width=l.height=128;let u=l.getContext(`2d`),d=u.createRadialGradient(64,64,0,64,64,64);d.addColorStop(0,`rgba(0,240,255,0.5)`),d.addColorStop(.5,`rgba(0,240,255,0.15)`),d.addColorStop(1,`rgba(0,240,255,0)`),u.fillStyle=d,u.fillRect(0,0,128,128);let f=new ti(l);f.colorSpace=Fe;let p=new X(new ci(2.5,2.5),new Y({map:f,transparent:!0,depthWrite:!1,blending:2}));return p.rotation.x=-Math.PI/2,p.position.y=.04,n.add(p),n.position.set(e,0,t),{mesh:n,point:{position:new G(e,0,t),triggerRadius:3,id:`contact_kiosk`,onEnter:()=>{let e=document.getElementById(`contact-overlay`);if(!e)return;e.querySelector(`.contact-name`).textContent=bl.name,e.querySelector(`.contact-age`).textContent=String(bl.age),e.querySelector(`.contact-college`).textContent=bl.college,e.querySelector(`.contact-role`).textContent=bl.role;let t=e.querySelector(`.contact-github`);t.href=bl.github,t.textContent=bl.github;let n=e.querySelector(`.contact-email`);n.href=`mailto:${bl.email}`,n.textContent=bl.email;let r=e.querySelector(`.contact-linkedin`);r.href=bl.linkedin,r.textContent=bl.linkedin,e.classList.add(`visible`)},onExit:()=>{let e=document.getElementById(`contact-overlay`);e&&e.classList.remove(`visible`)}}}}function wl(){let e=new an,t=[],n=[],r=4.5,i=[[r*.7,r*.7],[-4.5*.7,r*.7],[r*.7,-4.5*.7],[-4.5*.7,-4.5*.7]];yl.forEach((r,a)=>{let[o,s]=i[a],c=Sl(r,o,s);e.add(c.mesh),t.push(c.point),n.push({x:o,z:s,color:r.color,label:r.title})});let a=Cl(0,-6);return e.add(a.mesh),t.push(a.point),n.push({x:0,z:-6,color:`#00f0ff`,label:`CONTACT`}),{group:e,points:t,minimapPOIs:n}}function Tl(e){let t=Array(e.length).fill(!1),n=new G;return{update(r){for(let i=0;i<e.length;i++){let a=e[i];n.copy(r).sub(a.position),n.y=0;let o=n.length()<a.triggerRadius;o&&!t[i]?a.onEnter():!o&&t[i]&&a.onExit(),t[i]=o}}}}var El=class{canvas;ctx;pois;chunkHalf;size=180;constructor(e,t){this.chunkHalf=e,this.pois=t,this.canvas=document.createElement(`canvas`),this.canvas.width=this.canvas.height=this.size,this.canvas.id=`minimap`,this.canvas.style.cssText=`
      position: fixed;
      top: 1rem;
      right: 1rem;
      width: 180px;
      ...
      border-radius: 4px;
    `,document.body.appendChild(this.canvas),this.ctx=this.canvas.getContext(`2d`)}show(){this.canvas.style.opacity=`0.95`}hide(){this.canvas.style.opacity=`0`}update(e,t){let n=this.ctx,r=this.size,i=r/2,a=i/(this.chunkHalf+2);n.fillStyle=`rgba(10,0,20,0.95)`,n.fillRect(0,0,r,r),n.strokeStyle=`rgba(0,240,255,0.12)`,n.lineWidth=1;for(let e=0;e<=4;e++){let t=e/4*r;n.beginPath(),n.moveTo(t,0),n.lineTo(t,r),n.stroke(),n.beginPath(),n.moveTo(0,t),n.lineTo(r,t),n.stroke()}n.strokeStyle=`rgba(255,43,214,0.6)`,n.lineWidth=2,n.beginPath(),n.moveTo(i,0),n.lineTo(i,r),n.moveTo(0,i),n.lineTo(r,i),n.stroke(),n.strokeStyle=`rgba(255,43,214,0.7)`,n.lineWidth=1.5,n.beginPath(),n.arc(i,i,3*a,0,Math.PI*2),n.stroke();for(let e of this.pois){let t=i+e.x*a,r=i+e.z*a;n.fillStyle=e.color,n.shadowColor=e.color,n.shadowBlur=6,n.fillRect(t-4,r-4,8,8),n.shadowBlur=0}let o=i+e.x*a,s=i+e.z*a,c=-Math.sin(t),l=-Math.cos(t);n.fillStyle=`#00f0ff`,n.shadowColor=`#00f0ff`,n.shadowBlur=8,n.beginPath(),n.moveTo(o+c*9,s+l*9),n.lineTo(o-c*4-l*5,s-l*4+c*5),n.lineTo(o-c*4+l*5,s-l*4-c*5),n.closePath(),n.fill(),n.shadowBlur=0,n.strokeStyle=`#00f0ff`,n.lineWidth=2,n.strokeRect(0,0,r,r),n.fillStyle=`#9ad7ff`,n.font=`11px "Share Tech Mono", monospace`,n.textAlign=`left`,n.fillText(`SECTOR 7`,8,14),n.textAlign=`right`,n.fillText(`${e.x.toFixed(1)}, ${e.z.toFixed(1)}`,r-8,r-8)}dispose(){this.canvas.remove()}},Dl=class{ctx=null;masterGain=null;nodes=[];enabled=!1;ensureContext(){if(this.ctx)return;let e=window.AudioContext||window.webkitAudioContext;e&&(this.ctx=new e,this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.18,this.masterGain.connect(this.ctx.destination))}toggle(){return this.enabled?this.stop():this.start(),this.enabled}start(){if(this.ensureContext(),!this.ctx||!this.masterGain)return;this.ctx.state===`suspended`&&this.ctx.resume();let e=this.ctx,t=e.createOscillator();t.type=`sine`,t.frequency.value=55;let n=e.createOscillator();n.type=`sine`,n.frequency.value=82.41;let r=e.createGain();r.gain.value=.35,t.connect(r),n.connect(r),r.connect(this.masterGain),t.start(),n.start(),this.nodes.push(t,n,r);let i=e.createOscillator();i.type=`triangle`,i.frequency.value=220;let a=e.createGain();a.gain.value=.06;let o=e.createOscillator();o.frequency.value=.18;let s=e.createGain();s.gain.value=.035,o.connect(s),s.connect(a.gain),i.connect(a),a.connect(this.masterGain),i.start(),o.start(),this.nodes.push(i,a,o,s);let c=2*e.sampleRate,l=e.createBuffer(1,c,e.sampleRate),u=l.getChannelData(0);for(let e=0;e<c;e++)u[e]=Math.random()*2-1;let d=e.createBufferSource();d.buffer=l,d.loop=!0;let f=e.createBiquadFilter();f.type=`lowpass`,f.frequency.value=1100;let p=e.createGain();p.gain.value=.09,d.connect(f),f.connect(p),p.connect(this.masterGain),d.start(),this.nodes.push(d,f,p),this.enabled=!0}stop(){for(let e of this.nodes)try{e.stop&&e.stop(),e.disconnect()}catch{}this.nodes=[],this.enabled=!1}};function Ol(){let e=new an,t=[524559,655896,1049634,1311784],n=[16722902,61695,16770560,10309119,3800852];for(let r=0;r<55;r++){let i=r/55*Math.PI*2+(Math.random()-.5)*.1,a=45+Math.random()*25,o=3+Math.random()*5,s=8+Math.random()*28,c=3+Math.random()*5,l=new Y({color:t[r%t.length],fog:!0}),u=new X(new ai(o,s,c),l);if(u.position.set(Math.cos(i)*a,s/2,Math.sin(i)*a),e.add(u),Math.random()<.4){let t=new Y({color:n[Math.floor(Math.random()*n.length)],fog:!0}),r=new X(new ai(o*1.02,.4,c*1.02),t);r.position.set(u.position.x,s*(.55+Math.random()*.3),u.position.z),e.add(r)}}return e}var kl={name:`ARJUN1K`,age:19,college:`COEP Tech`,role:`Gamer`,github:`arjun1k-dev`};function Al(){let e=e=>document.getElementById(e);return{app:e(`app`),intro:e(`intro`),loader:e(`loader`),crosshair:e(`crosshair`),hud:e(`hud`),hudPos:e(`hud-pos`),hudSpd:e(`hud-spd`),hudFps:e(`hud-fps`),boundary:e(`boundary`),dismissBoundary:e(`dismiss-boundary`),audioBtn:e(`audio-btn`)}}async function jl(){let e=Al();if(document.fonts&&document.fonts.ready)try{await document.fonts.ready}catch{}let t=new kc({antialias:!1,powerPreference:`low-power`,stencil:!1,depth:!0});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setSize(window.innerWidth,window.innerHeight),t.outputColorSpace=Fe,e.app.appendChild(t.domElement),t.domElement.style.display=`block`;let n=el(),r=new mn;r.add(n.group),r.fog=n.fog,r.background=new J(1705011),r.add(Ol());let i=gl();r.add(i.mesh);let a=vl();r.add(a.group);let o=new Ki(72,window.innerWidth/window.innerHeight,.05,200),s=await sl(kl),c=-n.chunkHalf-.4;s.group.position.set(0,0,c),r.add(s.group);let l=wl();r.add(l.group);let u=new ml({domElement:t.domElement,camera:o,colliders:n.colliders,chunkHalf:n.chunkHalf,floorY:n.floorY,onBoundaryHit:()=>{e.boundary.classList.add(`visible`),document.pointerLockElement&&document.exitPointerLock()}}),d={min:new W(s.collider.min.x,s.collider.min.y+c),max:new W(s.collider.max.x,s.collider.max.y+c)};u.addCollider(d);let f=hl(n.lampHeads),p=Tl(l.points),m=[...l.minimapPOIs,{x:0,z:c,color:`#ff2bd6`,label:`BILLBOARD`}],h=new El(n.chunkHalf,m),g=new Dl;window.addEventListener(`resize`,()=>{let e=window.innerWidth,n=window.innerHeight;t.setSize(e,n),o.aspect=e/n,o.updateProjectionMatrix()}),e.intro.addEventListener(`click`,()=>{e.intro.classList.add(`hidden`),e.crosshair.classList.add(`visible`),e.hud.classList.add(`visible`),e.audioBtn.classList.add(`visible`),h.show(),t.domElement.requestPointerLock()}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement||e.boundary.classList.contains(`visible`)||(e.intro.classList.remove(`hidden`),e.crosshair.classList.remove(`visible`),e.hud.classList.remove(`visible`),e.audioBtn.classList.remove(`visible`),h.hide())}),e.dismissBoundary.addEventListener(`click`,()=>{e.boundary.classList.remove(`visible`),u.resetBoundary(),t.domElement.requestPointerLock()}),e.audioBtn.addEventListener(`click`,()=>{let t=g.toggle();e.audioBtn.textContent=t?`AUDIO: ON`:`AUDIO: OFF`,e.audioBtn.classList.toggle(`on`,t)}),e.loader.classList.add(`hidden`);let _=new ua,v=0,y=0,b=0,x=0,S=()=>{let n=_.getElapsedTime(),c=Math.min(.05,n-v);v=n;let l=u.update(c);i.update(c),f.update(n),a.update(n),p.update(l.pos),h.update(l.pos,u.yaw),s.material.uniforms.uTime.value=n;let d=.2*(.5+.5*Math.sin(n*.7));if(s.material.uniforms.uGlitchStrength.value=.45+d,y+=c,b++,n-x>.1){let t=b/y;e.hudFps.textContent=t.toFixed(0),e.hudPos.textContent=`${l.pos.x.toFixed(1)},${l.pos.z.toFixed(1)}`,e.hudSpd.textContent=l.speed,y=0,b=0,x=n}t.render(r,o),requestAnimationFrame(S)};requestAnimationFrame(S)}jl().catch(e=>{console.error(`Failed to initialize:`,e);let t=document.getElementById(`loader`);t&&(t.innerHTML=`<div style="color:#ff2bd6;font-family:monospace;padding:2rem;">FATAL: ${String(e)}</div>`)});